...
curl -s -X POST \
  ...
  http://localhost:8787/api/v1/workflows/custom
```
...
curl -s -X DELETE \
  -H "Authorization: Bearer aiwenchuang" \
  -H "Content-Type: application/json" \
  http://localhost:8787/api/v1/workflows/custom/translate-workflow
```
...
```json
{
  ...
  "data": {
    ...
    "viewUrl": "http://localhost:8787/api/v1/content/4ad7e901400ace34",
    "htmlUrl": "http://localhost:8787/api/v1/content/4ad7e901400ace34/html",
    "template": "article_wechat",
    "title": "AI技术发展趋势",
...
curl -s -X GET \
  -H "Authorization: Bearer aiwenchuang" \
  -H "Content-Type: application/json" \
  http://localhost:8787/api/v1/content/4ad7e901400ace34
```
...
curl -s -X GET \
  -H "Authorization: Bearer aiwenchuang" \
  http://localhost:8787/api/v1/content/4ad7e901400ace34/html
```
...
curl -s -X GET \
  -H "Authorization: Bearer aiwenchuang" \
  -H "Content-Type: application/json" \
  http://localhost:8787/api/v1/content/4ad7e901400ace34/url
```
...
```json
{
  ...
  "data": {
    "contentId": "4ad7e901400ace34",
    "htmlUrl": "http://localhost:8787/api/v1/content/4ad7e901400ace34/html",
    "directUrl": "http://localhost:8787/api/v1/content/4ad7e901400ace34/html"
  },
  "meta": {
...
curl -s -X GET \
  -H "Authorization: Bearer aiwenchuang" \
  -H "Content-Type: application/json" \
  http://localhost:8787/api/v1/content
```
...
curl -s -X DELETE \
  -H "Authorization: Bearer aiwenchuang" \
  -H "Content-Type: application/json" \
  http://localhost:8787/api/v1/content/a19e9bc75c338298
```
